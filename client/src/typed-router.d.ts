...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/[user]/[repository]': RouteRecordInfo<'/[user]/[repository]', '/:user/:repository', { user: ParamValue<true>, repository: ParamValue<true> }, { user: ParamValue<false>, repository: ParamValue<false> }>,
